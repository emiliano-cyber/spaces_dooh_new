...
| **T-01** | [código] · **fuera del plan** | ejecutor | — | PENDIENTE | `bootstrap-auth.mjs:54` inserta en `usuarios` sin `tenant_id`. Autorizada por Jochelo el 2026-08-13 tras la parada de F1.2. **Su contrato es el prompt, no el plan** |
