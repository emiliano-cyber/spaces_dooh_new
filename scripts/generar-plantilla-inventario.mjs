...
const COLS = [
  ...
  { k: 'renta_arrendador', obl: false, desc: 'Lo que se le PAGA al arrendador por el espacio (sin IVA). Es el único costo de la pantalla. Si lo dejas vacío, el contrato queda pendiente de captura en Arrendadores.', valido: 'Número mayor que cero', ej1: 52000, ej2: 28000 },
...
const instr = [
  ...
  [],
  ['Reglas importantes:'],
  ['• Campos OBLIGATORIOS: nombre, exhibicion, unidad, tarifa_publicada. Si falta uno, la fila se rechaza.'],
  ['• Una pantalla tiene UN SOLO costo: renta_arrendador, lo que se le paga al dueño del espacio.'],
  ['  Ya NO existe un "costo_compra" aparte. Si tu archivo viejo trae esa columna, su importe se'],
  ['  registra como la renta (es el mismo dinero) y se te avisa en el resultado de la carga.'],
